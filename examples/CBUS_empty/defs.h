...
static const byte LED_GRN = 22;                  // CBUS green SLiM LED pin
static const byte LED_YLW = 23;                  // CBUS yellow FLiM LED pin

static const byte SWITCH0 = 21;                  // CBUS push button switch pin
